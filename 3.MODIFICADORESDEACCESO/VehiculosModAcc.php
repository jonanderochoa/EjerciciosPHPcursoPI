...
class Coche{
    ...
    function set_Color($nombre_coche, $color_coche){
        $this->color = $color_coche;
        echo "El color del ".$nombre_coche." es ".$this->color."<br>";
    }
    
    /**
     * Funcion getter que devuelve el numero de ruedas
     * @return integer numero de ruedas
     */
    function get_ruedas(){
        return $this->ruedas;
    }
...
class Camion extends Coche{
    ...
    function set_Color($nombre_camion, $color_camion){
